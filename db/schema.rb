...
ActiveRecord::Schema.define(version: 20180113020423) do
  ...
  create_table "spree_fancy_menu_items", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.integer "index"
    t.integer "depth"
    t.datetime "created_at", null: false
